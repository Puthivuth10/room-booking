  ...
  const carouselData = [
    {
      img: room1,
      title: "Room 305",
      desc: "Modern conference facility with capacity for 30 people. Equipped with latest technology for presentations and meetings.",
    },
    {
      img: room2,
    ...
    },
    {
      img: room2,
      title: "NICC Studio",
      desc: "Grand auditorium with capacity for 50   attendees. Ideal for large events, ceremonies, and major presentations.",
    },
  ];
